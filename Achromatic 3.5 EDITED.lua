...
local modeInfo={
	...
	{Name="GASTER",Walkspeed=16,moveVal=9,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,255,255);Music=619724986,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};WingAnim='StarGASTER'};
	...
	{Name="RIDDLER",Walkspeed=75,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(0,0,0);Music=6577287143,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};WingAnim='StarLOL'};
	...
	{Name="INFERNO",Walkspeed=67,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,152,220);Music=3196754678,LeftWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};WingAnim='NebCALAMITAS1'};
	...
	{Name="EUCLIDEAN",Walkspeed=90,moveVal=20,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255, 0, 0);Music=2272275958,LeftWing={0,BrickColor.new'Dark blue'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Glass};WingAnim={'NebCALAMITASsmol',10}};
    ...
    {Name="DESTRUCTION",Walkspeed=186,moveVal=8,Font=Enum.Font.Garamond,StrokeColor=C3.RGB(0,0,0);Music=1931105585,LeftWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Glass};WingAnim='GALACTUSA'};	
	{Name="CHRONOS",Walkspeed=90,moveVal=8,Font=Enum.Font.Arcade,StrokeColor=C3.N(.2,.2,.2);Music=2083683898,LeftWing={0,BrickColor.new'Olivine'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Olivine'.Color,Enum.Material.Glass};WingAnim={'StarAs'}};
...
UIS.InputBegan:connect(function(io,gpe)
	...
	elseif(io.KeyCode == Enum.KeyCode.L and Mode~='LEGMAN')then
		changeMode'LEGMAN'
	elseif(io.KeyCode == Enum.KeyCode.T and Mode~='INSANITY')then 
		changeMode'INSANITY'
	elseif(io.KeyCode == Enum.KeyCode.Nine and Mode~='HORROR')then
		changeMode'HORROR'
	elseif(io.KeyCode == Enum.KeyCode.U and Mode=='Sadness')then 
		changeMode'CHRONOS'
	...
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='+DANGEROUS+')then 
		changeMode'NEPTUNIAN V (UNEQUIPPED)'
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='NEPTUNIAN V')then 
		changeMode'NEPTUNIAN V (UNEQUIPPED)'
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='NEPTUNIAN V (UNEQUIPPED)')then 
...
WingAnims.StarGASTER=function()
	...
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(0*M.C(WingSine/32),1+0*M.S(WingSine/32),-1)*CF.A(0,0,M.R(60-360*M.C(WingSine/50))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-11.5,.5,-1+1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(-30-5*M.C(WingSine/1))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),7,M.R(-30-800*M.C(WingSine/50))),.2)
...
WingAnims.StarLOL=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(-0.40,0,-0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-50+40*M.C(WingSine/16))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(-0.40,5,-0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-50+40*M.C(WingSine/16))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-0.40,10,-0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-50+40*M.C(WingSine/16))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(0.40,0,-0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(50-40*M.C(WingSine/16))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(0.40,5,-0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(50-40*M.C(WingSine/16))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(0.40,10,-0)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(50-40*M.C(WingSine/16))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
...
WingAnims.SONUS3=function()
	...
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-3)*CF.A(M.R(15+0*M.C(WingSine/32)),0,M.R(-100-2*M.C(WingSine/192))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-10)*CF.A(0,1,M.R(-270-3200*M.C(WingSine/290))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(-6*M.C(WingSine/32),1.5-3*M.C(WingSine/32),-10)*CF.A(0,1,M.R(-240-3200*M.C(WingSine/290))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end
...
WingAnims.NebCALAMITASsmol=function(div)
            div=div or 1
			LWP1W.C0 = LWP1W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0+5000*M.C(WingSine/200))),.2)
	        LWP2W.C0 = LWP2W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(60+5000*M.C(WingSine/200))),.2)
	        LWP3W.C0 = LWP3W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(120+5000*M.C(WingSine/200))),.2)

			RWP1W.C0 = RWP1W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(180+5000*M.C(WingSine/200))),.2)
	        RWP2W.C0 = RWP2W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(240+5000*M.C(WingSine/200))),.2)
	        RWP3W.C0 = RWP3W.C0:lerp(CF.N(1,1.5,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(300+5000*M.C(WingSine/200))),.2)
            RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	        RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	        RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	        RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.NebCALAMITAS1=function(div)
            div=div or 1
			LWP1W.C0 = LWP1W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(0+6.5*M.C(WingSine/36)),M.R(0+5000*M.C(WingSine/200))),.2)
	        LWP2W.C0 = LWP2W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(0+2.5*M.C(WingSine/32)),M.R(60+5000*M.C(WingSine/200))),.2)
	        LWP3W.C0 = LWP3W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(120+5000*M.C(WingSine/200))),.2)

			RWP1W.C0 = RWP1W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(180+5000*M.C(WingSine/200))),.2)
	        RWP2W.C0 = RWP2W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(0+1.5*M.C(WingSine/32)),M.R(240+5000*M.C(WingSine/200))),.2)
	        RWP3W.C0 = RWP3W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(300+5000*M.C(WingSine/200))),.2)
            RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	        RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	        RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	        RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.NebG521=function(div)
	div=div or 1.5
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(-5*M.C(WingSine/32),10-9-3*M.C(WingSine/32),-1)*CF.A(100,0,M.R(-150-5000*M.C(WingSine/322))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(-5*M.C(WingSine/32),10-9-3*M.C(WingSine/32),-1)*CF.A(100,0,M.R(-180-5000*M.C(WingSine/322))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-5*M.C(WingSine/32),10-9-3*M.C(WingSine/32),-1)*CF.A(100,0,M.R(-210-5000*M.C(WingSine/322))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-5*M.C(WingSine/32),10-9-3*M.C(WingSine/32),-1)*CF.A(100,0,M.R(-60-5000*M.C(WingSine/322))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-5*M.C(WingSine/32),10-9-3*M.C(WingSine/32),-1)*CF.A(100,0,M.R(-90-5000*M.C(WingSine/322))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-5*M.C(WingSine/32),10-9-3*M.C(WingSine/32),-1)*CF.A(100,0,M.R(-120-5000*M.C(WingSine/322))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-5*M.C(WingSine/32),10-9-3*M.C(WingSine/32),-1)*CF.A(100,0,M.R(-270-5000*M.C(WingSine/322))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(-5*M.C(WingSine/32),10-9-3*M.C(WingSine/32),-1)*CF.A(100,0,M.R(-240-5000*M.C(WingSine/322))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end

WingAnims.NebDARY=function(div)
	div=div or 2
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(0,7,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0+2000*M.R(WingSine/div))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(0,7,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(120+2000*M.R(WingSine/div))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(0,7,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(-120+2000*M.R(WingSine/div))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(0,7,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0-2000*M.R(WingSine/div))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(0,7,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(120-2000*M.R(WingSine/div))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(0,7,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(-120-2000*M.R(WingSine/div))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
...
WingAnims.NebDARY1=function(div)
	div=div or 1.5
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(0,5,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(90+5000*M.C(WingSine/550))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(0,5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(1+5000*M.C(WingSine/550))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(0*M.C(WingSine/1),3+0*M.S(WingSine/1),-1)*CF.A(0,0,M.R(180-360*M.C(WingSine/32))),.2)
	 
    RWP1W.C0 = RWP1W.C0:lerp(CF.N(0,5,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(-90+5000*M.C(WingSine/550))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(0,5,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(-180+5000*M.C(WingSine/550))),.2)
    RWP3W.C0 = RWP3W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/255))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
...
if(legAnims)then 
		...
		elseif(Mode=='ENERGY')then
			local Alpha = .1
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,30+3.20*M.C(Sine/17),0)*CF.A(M.R(0+3*M.S(Sine/64)),0,0),Alpha)
				if(M.RNG(1,45)==1)then
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
				else
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),0,0),Alpha)
		...
		elseif(Mode=='CHRONOS')then
			...
			if(NeutralAnims)then	
				...
				LS.C0 = LS.C0:lerp(LSC0*CF.N(.5,-.1+.2*M.S(Sine/32),-.8)*CF.A(M.R(13),M.R(-12),M.R(104-2*M.S(Sine/36))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(-.5,0+.2*M.S(Sine/32),-.6)*CF.A(M.R(-17),M.R(-20),M.R(-79+1*M.S(Sine/36))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
		...
		elseif(Mode=='+MONSTRONIX+')then
			...
			local Alpha = .1
			if(NeutralAnims)then
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.2+.4*M.C(Sine/39),10+.2*M.C(Sine/32),0)*CF.A(M.R(-2+5*M.S(Sine/58)),M.R(-15+5*M.C(Sine/42)),0),Alpha)
				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-7-2.5*M.S(Sine/32)),M.R(15),0),Alpha)
...
if(legAnims)then 
			...
			local Alpha = .1
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,10+3*M.C(Sine/15),0)*CF.A(M.R(-25+1*M.S(Sine/64)),0,0),Alpha)
				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/7)),M.R(-5),0),Alpha)
				LS.C0 = LS.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/7),0)*CF.A(M.R(25),M.R(5+5*M.C(Sine/32)),M.R(-10-5*M.C(Sine/32))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/7),0)*CF.A(M.R(25),M.R(5-5*M.C(Sine/32)),M.R(10+5*M.C(Sine/32))),Alpha)
			end
...
if(legAnims)then 
	...
	--custom walks--
		...
		if(Mode=='RIDDLER')then
			local Alpha = .1
  			if(NeutralAnims)then
 				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.3+.4*M.C(Sine/39),10+.2*M.C(Sine/32),0)*CF.A(M.R(-15+5*M.S(Sine/58)),M.R(0+5*M.C(Sine/42)),0),Alpha)
...
elseif(State == 'Walk')then
 ...
 elseif(State == 'Walk')then
		...
		local Alpha = .1
  			if(NeutralAnims)then
 				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.3+.4*M.C(Sine/39),13+3*M.C(Sine/32),0)*CF.A(M.R(-15+5*M.S(Sine/58)),M.R(0+5*M.C(Sine/42)),0),Alpha)
 				LS.C0 = LS.C0:lerp(CFrame.new(-1.50198829, 0.580981374, 0.000380858371, 0.963434994, 0.267942399, 1.75953949e-06, -0.267942399, 0.963434994, 5.1856041e-06, -3.05473804e-07, -5.48362732e-06, 1)*CF.A(-1,0,M.R(-7+5*M.S(Sine/32))),Alpha)
  				RS.C0 = RS.C0:lerp(CFrame.new(1.54895508, 0.519735038, 0.000380946265, 0.98034811, -0.197275475, -1.24170782e-07, 0.19727549, 0.980348051, 9.53674316e-07, -5.96046448e-08, -9.23871994e-07, 1)*CF.A(-1,0,M.R(7-5*M.S(Sine/32))),Alpha)
  				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
