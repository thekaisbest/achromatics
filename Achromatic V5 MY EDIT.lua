...
local modeInfo={
	...
	{Name="DESTINY",Walkspeed=130,moveVal=20,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(255,0,255);Music=2313332891,LeftWing={0,BrickColor.new'Light purple'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Light purple'.Color,Enum.Material.Glass};WingAnim='StarL'};	
    ...
    {Name="BEYOND",Walkspeed=56,moveVal=8,Font=Enum.Font.Arcade,StrokeColor=C3.N(0,0,0);Music=2071274388,LeftWing={0,BrickColor.new'Magenta'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Magenta'.Color,Enum.Material.Glass};WingAnim='SONUS3'};
	{Name="TROLLGE",Walkspeed=14,moveVal=8,Font=Enum.Font.Gotham,StrokeColor=C3.N(.1,.1,.1);Music=6588022322,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Really black'.Color,Enum.Material.Glass};WingAnim={'INSANEGREG',2}};
	...
	{Name="INFERNO",Walkspeed=67,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,152,220);Music=1609011649,LeftWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};WingAnim='NebCALAMITAS1'};
	...
	{Name="VORTEX",Walkspeed=186,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.N(255,.9,0);Music=4590629941,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Dark stone grey'.Color,Enum.Material.Glass};WingAnim={'GALACTUS'}};
	...
	{Name="S P A C E T I M E",Walkspeed=186,moveVal=20,Font=Enum.Font.Arcade,StrokeColor=C3.N(0,0,0);Music=4597078271,LeftWing={0,BrickColor.new'Black metallic'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Black metallic'.Color,Enum.Material.Glass};WingAnim={'NebSPACE',20}};
	...
	{Name="INSANITY",Walkspeed=14,moveVal=8,Font=Enum.Font.Garamond,StrokeColor=C3.N(.1,.1,.1);Music=924339757,LeftWing={0,BrickColor.new'Dark stone grey'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Really black'.Color,Enum.Material.Glass};WingAnim={'INSANEGREG2',2}};
	{Name="Space Traveler",Walkspeed=90,moveVal=20,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255, 0, 0);Music=2272275958,LeftWing={0,BrickColor.new'Dark blue'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Glass};WingAnim={'NebCALAMITASsmol',10}};
	...
	{Name="BETRAYAL",Walkspeed=18,moveVal=8,Font=Enum.Font.Arcade,StrokeColor=C3.N(.4,.4,0);Music=2525700576,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'White'.Color,Enum.Material.Glass};WingAnim={'BETRAY',10}};
...
if game.Players.LocalPlayer.Character:FindFirstChild("DJ's Sword") then --DJ's Sword
	...
	local HatChoice = game.Players.LocalPlayer.Character:FindFirstChild("DJ's Sword") --DJ's Sword
	HatChoice.Handle:FindFirstChildOfClass("AlignPosition").Attachment1 = athp
	HatChoice.Handle:FindFirstChildOfClass("AlignOrientation").Attachment1 = atho

	athp.Position = Vector3.new(0,-1.75,0)
	atho.Rotation = Vector3.new(0,0,-180)
end
...
if game.Players.LocalPlayer.Character:FindFirstChild("Russo's Sword") then --Russo's Sword
	...
	local HatChoice = game.Players.LocalPlayer.Character:FindFirstChild("Russo's Sword") --Russo's Sword
	HatChoice.Handle:FindFirstChildOfClass("AlignPosition").Attachment1 = athp
	HatChoice.Handle:FindFirstChildOfClass("AlignOrientation").Attachment1 = atho

	athp.Position = Vector3.new(0,-1.75,0)
	atho.Rotation = Vector3.new(0,0,-180) -- 48
end

RWP3.Parent = rightWing
local RWP4 = WingPiece:Clone();
if game.Players.LocalPlayer.Character:FindFirstChild("WDW_FoamFinger") then --WDW_FoamFinger
	...
	local HatChoice = game.Players.LocalPlayer.Character:FindFirstChild("WDW_FoamFinger") --WDW_FoamFinger
	HatChoice.Handle:FindFirstChildOfClass("AlignPosition").Attachment1 = athp
	HatChoice.Handle:FindFirstChildOfClass("AlignOrientation").Attachment1 = atho
...
UIS.InputBegan:connect(function(io,gpe)
	...
	elseif(io.KeyCode == Enum.KeyCode.U and Mode=='RIDDLER')then 
		changeMode'HYPNOSIS'
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='Space Traveler')then 
	...
	elseif(io.KeyCode == Enum.KeyCode.U and Mode=='Dark Matter')then 
		changeMode'Space Traveler'
	...
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='ARCHANGEL')then 
		changeMode'PESTILENCE'
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='HORROR')then 
	...
	elseif(io.KeyCode == Enum.KeyCode.U and Mode=='SANS')then 
		changeMode'RIDDLER'
	elseif(io.KeyCode == Enum.KeyCode.U and Mode=='+DANGEROUS+')then 
		changeMode'INFERNO'
	elseif(io.KeyCode == Enum.KeyCode.U and Mode=='LEGMAN')then 
		changeMode'THE LAST MAN ALIVE'
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='=-XESTER-=')then 
		changeMode'ACE OF SPADES'
	elseif(io.KeyCode == Enum.KeyCode.V and Mode=='HORROR')then 
		changeMode'Determined'
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='BETRAYAL')then 
		changeMode'OVERKILL'
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='N U C L E A R - WASTE')then 
		changeMode'D O O M'
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='Dark Matter')then
		changeMode'B O U N C E ;)'
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='DESTINY')then
		changeMode'Galaxy'
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='DESTINY')then
		changeMode'CALAMITY'
	...
	elseif(io.KeyCode == Enum.KeyCode.H and Mode=='CATASTROPHE')then
		changeMode'CATACALYSM'
		
			elseif(io.KeyCode == Enum.KeyCode.H and Mode=='SANS')then 
		changeMode'GASTER'

	elseif(io.KeyCode == Enum.KeyCode.U and Mode=='HORROR')then
...
WingAnims.StarLFR=function()
	...
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(-6.5,.5,-1)*CF.A(M.R(15+2*M.C(WingSine/32)),7,M.R(-30-800*M.C(WingSine/50))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-15,-2,-1-1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(-30-5*M.C(WingSine/1))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(15,-2,-1-1)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(30+5*M.C(WingSine/1))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end
...
WingAnims.StarLOL=function()
	...
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/32),1+0*M.C(WingSine/32),-1)*CF.A(0,0,M.R(240-360*M.C(WingSine/50))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),1+0*M.S(WingSine/32),-1)*CF.A(0,0,M.R(60-360*M.C(WingSine/50))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)		
end

WingAnims.StarLOXD=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(-0.40,0,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-90+360*M.C(WingSine/15))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(-0.40,5,-2)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-90+180*M.C(WingSine/15))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)

	RWP1W.C0 = RWP1W.C0:lerp(CF.N(0.40,0,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(90-360*M.C(WingSine/15))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(0.40,5,-2)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(90-180*M.C(WingSine/15))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/32),1+0*M.C(WingSine/32),-3)*CF.A(0,0,M.R(240-360*M.C(WingSine/50))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),1+0*M.S(WingSine/32),-3)*CF.A(0,0,M.R(60-360*M.C(WingSine/50))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)		
end
...
WingAnims.StarLTE=function()
	...
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(7,.5,-5)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(30+500*M.C(WingSine/64))),.2)
    ...
    RWP2W.C0 = RWP2W.C0:lerp(CF.N(-7,.5,-5)*CF.A(M.R(15+20*M.C(WingSine/32)),0,M.R(-30-500*M.C(WingSine/64))),.2)
...
WingAnims.NebJEVIL=function(div)
            div=div or 1
			LWP1W.C0 = LWP1W.C0:lerp(CF.N(9,2,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(0+5000*M.C(WingSine/400)))*CF.A(20.5,M.R(2),0)*CF.N(-0,4,0),.2)
	        LWP2W.C0 = LWP2W.C0:lerp(CF.N(9,2,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(90+5000*M.C(WingSine/400)))*CF.A(20.5,M.R(2),0)*CF.N(-0,4,0),.2)
			...
			RWP1W.C0 = RWP1W.C0:lerp(CF.N(9,2,-1)*CF.A(0,M.R(0+2.5*M.C(WingSine/36)),M.R(-180+5000*M.C(WingSine/400)))*CF.A(20.5,M.R(2),0)*CF.N(-0,4,0),.2)
	        RWP2W.C0 = RWP2W.C0:lerp(CF.N(9,2,-1)*CF.A(0,M.R(0+7.5*M.C(WingSine/32)),M.R(-90+5000*M.C(WingSine/400)))*CF.A(20.5,M.R(2),0)*CF.N(-0,4,0),.2)
...
WingAnims.Flowhor=function()
			LWP1W.C0 = LWP1W.C0:lerp(CF.N(.12,1,-4)*CF.A(M.R(9+4300*M.C(WingSine/322)),44,M.R(36)),.2)
			LWP2W.C0 = LWP2W.C0:lerp(CF.N(.4,5,-2)*CF.A(M.R(10+4300*M.C(WingSine/322)),44,M.R(91)),.2)
		    LWP3W.C0 = LWP3W.C0:lerp(CF.N(.29,3,-3)*CF.A(M.R(45+4300*M.C(WingSine/322)),44,M.R(120)),.2)

			RWP1W.C0 = RWP1W.C0:lerp(CF.N(-.12,1,-4)*CF.A(M.R(8+4300*M.C(WingSine/322)),44,M.R(-36)),.2)
			RWP2W.C0 = RWP2W.C0:lerp(CF.N(-.4,5,-2)*CF.A(M.R(10+4300*M.C(WingSine/322)),44,M.R(-91)),.2)
			RWP3W.C0 = RWP3W.C0:lerp(CF.N(-.29,3,-3)*CF.A(M.R(25+4300*M.C(WingSine/322)),44,M.R(-120)),.2)
			RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	        RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	        RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	        RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.whatthe=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(4,-2,-1)*CF.A(M.R(5+200*M.C(WingSine/32)),0,M.R(0+50*M.C(WingSine/32))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(9.5,-1,-1)*CF.A(M.R(10+200*M.C(WingSine/32)),0,M.R(15+70.5*M.C(WingSine/32))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(15,.5,-1)*CF.A(M.R(15+200*M.C(WingSine/32)),0,M.R(30+90*M.C(WingSine/32))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-4,-2,-1)*CF.A(M.R(5+200*M.C(WingSine/32)),0,M.R(0-50*M.C(WingSine/32))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-9.5,-1,-1+.05*M.S(WingSine/35))*CF.A(M.R(10+200*M.C(WingSine/32)),0,M.R(-15-70.50*M.C(WingSine/32))),.2)
...
WingAnims.StarLED=function()
	...
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-8.25,-1,-0+.05*M.S(WingSine/35))*CF.A(M.R(290+15*M.C(WingSine/32)),0,M.R(-15-7.5*M.C(WingSine/32))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(8.25,-1,-0)*CF.A(M.R(290+15*M.C(WingSine/32)),0,M.R(15+7.5*M.C(WingSine/32))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end

WingAnims.StarAs=function()
	div=div or 1.5
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(.1,2,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(90)),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(.25,2,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(1)),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(0*M.C(WingSine/1),1.5+0*M.S(WingSine/1),-1)*CF.A(0,0,M.R(180-360*M.C(WingSine/32))),.2)
	 
    RWP1W.C0 = RWP1W.C0:lerp(CF.N(-.1,2,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-90)),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-.25,2,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-180)),.2)	
    RWP3W.C0 = RWP3W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/255))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.StarA=function()
	...
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(0,-6,2)*CF.A(M.R(340+0*M.C(WingSine/32)),0,M.R(1+100*M.C(WingSine/64))),.2)
	...
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-0,-6,2)*CF.A(M.R(340+0*M.C(WingSine/32)),0,M.R(-1-100*M.C(WingSine/64))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.BETRAY=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(2,-2,-1)*CF.A(M.R(5+20*M.C(WingSine/32)),0,M.R(0+10*M.C(WingSine/32))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(6.25,-1,-1)*CF.A(M.R(10+30*M.C(WingSine/32)),0,M.R(15+15*M.C(WingSine/32))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(10.5,.5,-1)*CF.A(M.R(15+40*M.C(WingSine/32)),0,M.R(30+18*M.C(WingSine/32))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-2,-2,-1)*CF.A(M.R(5+20*M.C(WingSine/32)),0,M.R(0-10*M.C(WingSine/32))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-6.25,-1,-1+.05*M.S(WingSine/35))*CF.A(M.R(10+30*M.C(WingSine/32)),0,M.R(-15-15*M.C(WingSine/32))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-10.5,.5,-1)*CF.A(M.R(15+40*M.C(WingSine/32)),0,M.R(-30-18*M.C(WingSine/32))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-14.75,.10,-1)*CF.A(M.R(20+50*M.C(WingSine/32)),0,M.R(-45-21*M.C(WingSine/32))),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(14.75,.10,-1)*CF.A(M.R(20+50*M.C(WingSine/32)),0,M.R(45+21*M.C(WingSine/32))),.2)
	 RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/16),-1.64+0*M.S(WingSine/16),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
end
...
WingAnims.INSANEGREG2=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(.67,12.5,-1)*CF.A(M.R(5+1000*M.C(WingSine/38)),0,M.R(66)),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(.1,12.5,-1)*CF.A(M.R(10+1555*M.C(WingSine/38)),0,M.R(10)),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(.25,12.5,-1)*CF.A(M.R(15+2000*M.C(WingSine/38)),0,M.R(30)),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-.15,12.5,-1)*CF.A(M.R(5-1000*M.C(WingSine/38)),0,M.R(-64)),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-.1,12.5,-1)*CF.A(M.R(10-1555*M.C(WingSine/38)),0,M.R(-91)),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-.25,12.5,-1)*CF.A(M.R(15-2000*M.C(WingSine/38)),0,M.R(-17)),.2)
...
WingAnims.NebCALAMITAS1=function(div)
            div=div or 1
			LWP1W.C0 = LWP1W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(90+360*M.C(WingSine/32)),M.R(0+5000*M.C(WingSine/500))),.2)
	        LWP2W.C0 = LWP2W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(90+360*M.C(WingSine/32)),M.R(60+5000*M.C(WingSine/500))),.2)
	        LWP3W.C0 = LWP3W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(90+360*M.C(WingSine/32)),M.R(120+5000*M.C(WingSine/500))),.2)

			RWP1W.C0 = RWP1W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(90+360*M.C(WingSine/32)),M.R(180+5000*M.C(WingSine/500))),.2)
	        RWP2W.C0 = RWP2W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(90+360*M.C(WingSine/32)),M.R(240+5000*M.C(WingSine/500))),.2)
	        RWP3W.C0 = RWP3W.C0:lerp(CF.N(-0*M.C(WingSine/1),10-6*M.C(WingSine/32),-0)*CF.A(0,M.R(90+360*M.C(WingSine/32)),M.R(300+5000*M.C(WingSine/500))),.2)
            RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	        RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	        RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	        RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.Soul=function()
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(-0*M.C(WingSine/1),5-5*M.C(WingSine/32),-10)*CF.A(100,0,M.R(-150-5000*M.C(WingSine/322))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(-0*M.C(WingSine/1),5-5*M.C(WingSine/32),-10)*CF.A(100,0,M.R(-180-5000*M.C(WingSine/322))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(-0*M.C(WingSine/1),5-5*M.C(WingSine/32),-10)*CF.A(100,0,M.R(-210-5000*M.C(WingSine/322))),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-0*M.C(WingSine/1),5-5*M.C(WingSine/32),-10)*CF.A(100,0,M.R(-60-5000*M.C(WingSine/322))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-0*M.C(WingSine/1),5-5*M.C(WingSine/32),-10)*CF.A(100,0,M.R(-90-5000*M.C(WingSine/322))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(-0*M.C(WingSine/1),5-5*M.C(WingSine/32),-10)*CF.A(100,0,M.R(-120-5000*M.C(WingSine/322))),.2)
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
...
WingAnims.MANGYT=function()
	...
	RWP4W.C0 = RWP4W.C0:lerp(CF.N(6*M.C(WingSine/62),-3+3*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-30-950*M.C(WingSine/202))),.2)
	RWP5W.C0 = RWP5W.C0:lerp(CF.N(-.1,2.5,-3)*CF.A(M.R(10+300*M.C(WingSine/22)),0,M.R(-46)),.2)
	RWP6W.C0 = RWP6W.C0:lerp(CF.N(.1,2.5,-3)*CF.A(M.R(10+300*M.C(WingSine/22)),0,M.R(46)),.2)
	RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
end
...
WingAnims.Sonar2=function()
    LWP1W.C0 = LWP1W.C0:lerp(CF.N(5,10,-0)*CF.A(M.R(10+80000*M.C(WingSine/2000)),0,M.R(-90)),.2)
    LWP2W.C0 = LWP2W.C0:lerp(CF.N(5,10,-0)*CF.A(M.R(10+70000*M.C(WingSine/2000)),0,M.R(-90)),.2)
    LWP3W.C0 = LWP3W.C0:lerp(CF.N(5,10,-0)*CF.A(M.R(10+90000*M.C(WingSine/2000)),0,M.R(-90)),.2)
	
    RWP1W.C0 = RWP1W.C0:lerp(CF.N(-5,10,-0)*CF.A(M.R(10+80000*M.C(WingSine/2000)),0,M.R(-90)),.2)
    RWP2W.C0 = RWP2W.C0:lerp(CF.N(-5,10,-0)*CF.A(M.R(10+70000*M.C(WingSine/2000)),0,M.R(-90)),.2)
    RWP3W.C0 = RWP3W.C0:lerp(CF.N(-5,10,-0)*CF.A(M.R(10+90000*M.C(WingSine/2000)),0,M.R(-90)),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-0,0,-3)*CF.A(M.R(-90+90000*M.C(WingSine/200000000000000000000000000999999999999999999000000999900000099999999)),0,M.R(-0)),.2)
...
WingAnims.NebSPACE=function(div)
            div=div or 1
			LWP1W.C0 = LWP1W.C0:lerp(CF.N(1,1,-2)*CF.A(0,2,M.R(-150-5000*M.C(WingSine/250)))*CF.A(0,M.R(90),0)*CF.N(-5,0,0),.2)
	        LWP2W.C0 = LWP2W.C0:lerp(CF.N(1,1,-2)*CF.A(0,2,M.R(-0-5000*M.C(WingSine/250)))*CF.A(0,M.R(90),0)*CF.N(-5,0,0),.2)
	        LWP3W.C0 = LWP3W.C0:lerp(CF.N(1,1,-2)*CF.A(0,2,M.R(-270-5000*M.C(WingSine/250)))*CF.A(0,M.R(90),0)*CF.N(-5,0,0),.2)

			RWP1W.C0 = RWP1W.C0:lerp(CF.N(1,1,-2)*CF.A(0,2,M.R(-150-5000*M.C(WingSine/250)))*CF.A(0,M.R(90),0)*CF.N(8,0,0),.2)
	        RWP2W.C0 = RWP2W.C0:lerp(CF.N(1,1,-2)*CF.A(0,2,M.R(-0-5000*M.C(WingSine/250)))*CF.A(0,M.R(90),0)*CF.N(8,0,0),.2)
	        RWP3W.C0 = RWP3W.C0:lerp(CF.N(1,1,-2)*CF.A(0,2,M.R(-270-5000*M.C(WingSine/250)))*CF.A(0,M.R(90),0)*CF.N(8,0,0),.2)
            RWP4W.C0 = RWP4W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/432))),.2)
	        RWP5W.C0 = RWP5W.C0:lerp(CF.N(0*M.C(WingSine/62),-1.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0-950*M.C(WingSine/402))),.2)
	        RWP6W.C0 = RWP6W.C0:lerp(CF.N(0*M.C(WingSine/32),-5.64+0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+1950*M.C(WingSine/822))),.2)
	        RWP7W.C0 = RWP7W.C0:lerp(CF.N(0*M.C(WingSine/62),-3.64-0*M.S(WingSine/42),-2)*CF.A(0,0,M.R(-0+950*M.C(WingSine/402))),.2)	
...
WingAnims.INSANITYFrench=function()
...
if(legAnims)then 
			...
			elseif(Mode=='Space Traveler')then
					local Alpha = .1
			if(NeutralAnims)then
		...
		elseif(Mode=='BETRAYAL')then
			local Alpha = .1
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,0+.05*M.C(Sine/32),0)*CF.A(M.R(-50+1*M.S(Sine/64)),0,0),Alpha)
				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
				LS.C0 = LS.C0:lerp(LSC0*CF.N(.1,-0+.05*M.S(Sine/32),-0)*CF.A(M.R(50),M.R(-0),M.R(0-2*M.S(Sine/36))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(-.1,0+.05*M.S(Sine/32),0)*CF.A(M.R(175),M.R(5-2.5*M.C(Sine/32)),M.R(-25-1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LH.C0 = LH.C0:lerp(LHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(M.R(50),0,M.R(-3)),Alpha)
					RH.C0 = RH.C0:lerp(RHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(M.R(50),0,M.R(3)),Alpha)
				else
					LH.C0 = LH.C0:lerp(LHC0,Alpha)
					RH.C0 = RH.C0:lerp(RHC0,Alpha)
				end
  ...
  elseif(State == 'Walk')then
	  ...
	  elseif(State == 'Walk')then
		...
		if(Mode=='INSANITY')then
			local Alpha = .1
  			if(NeutralAnims)then
 				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(-.5+2.5*M.C(Sine/39),5+2.5*M.C(Sine/32),0)*CF.A(M.R(-56+5*M.S(Sine/58)),M.R(0+5*M.C(Sine/42)),0),Alpha)
 				LS.C0 = LS.C0:lerp(CFrame.new(-1.50198829, 0.580981374, 0.000380858371, 0.963434994, 0.267942399, 1.75953949e-06, -0.267942399, 0.963434994, 5.1856041e-06, -3.05473804e-07, -5.48362732e-06, 1)*CF.A(-1,0,M.R(-7+5*M.S(Sine/32))),Alpha)
  				RS.C0 = RS.C0:lerp(CFrame.new(1.54895508, 0.519735038, 0.000380946265, 0.98034811, -0.197275475, -1.24170782e-07, 0.19727549, 0.980348051, 9.53674316e-07, -5.96046448e-08, -9.23871994e-07, 1)*CF.A(-1,0,M.R(7-5*M.S(Sine/32))),Alpha)
  				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(65-5*M.S(Sine/58)),0,0),Alpha)
			end
...
elseif(State == 'Walk')then
							if(Mode=='S P A C E T I M E')then
								local Alpha = .1
								if(NeutralAnims)then
									RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,4.8+.2*M.C(Sine/24),0)*CF.A(M.R(-85+5*M.S(Sine/58)),M.R(0+5*M.C(Sine/42)),0),Alpha)
...
elseif(State == 'Walk')then
	  ...
	  elseif(State == 'Walk')then
		if(Mode=='OVERKILL')then
			...
			local wsVal = 4
			local Alpha = .2
			if(Mode=='+DANGEROUS+')then Change=.3 elseif(Mode=='Astronaut' or Mode=='=-RED XESTER-=')then Change=1 else Change=.5 end
			if(NeutralAnims)then
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,.05+Change/4*M.C(Sine/(wsVal/2)),0)*CF.A(M.R(-(Change*20)-movement/20*M.C(Sine/(wsVal/2)))*forwardvelocity,M.R(0+5*M.C(Sine/wsVal)),M.R(-(Change*20)-movement/20*M.C(Sine/(wsVal/2)))*sidevelocity+M.R(0-1*M.C(Sine/wsVal))),Alpha)
				NK.C0 = NK.C0:lerp(NKC0,Alpha)
				LS.C0 = LS.C0:lerp(LSC0*CF.N(0,0,0)*CF.A(M.R(0+55*(movement/8)*M.S(Sine/wsVal))*forwardvelocity,0,0),Alpha)
